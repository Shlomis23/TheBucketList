...
| 0032 | תגובות בן/בת הזוג לרשימת הרעיונות (תגית מצב) |
| 0033 | דוח בריאות למשימה היומית |
| 0034 | ערכת צבע אישית |
...
- ערכות צבע: `<html data-color="ocean|turquoise|mango">` מחליף את הטוקנים (סגול = ברירת מחדל); איורי הקטגוריות לכל ערכה ב-`public/images/covers/<theme>` (`node scripts/generate-theme-covers.mjs`), ו-`/covers/<cat>` מוגש לפי העוגייה (`proxy.ts`).
